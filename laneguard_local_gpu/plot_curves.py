#!/usr/bin/env python3
"""Plot training and validation curves from RT-DETR log.txt for the laneguard local GPU run."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot Laneguard RT-DETR training curves")
    parser.add_argument(
        "--log-file",
    ...
    parser.add_argument(
        "--output-image",
        default="/home/parvezdev/fydp/outputs/laneguard_local_gpu_100e/train_test_graph.png",
        help="Output PNG file",
    )
    parser.add_argument(
        "--title",
        default="Laneguard RT-DETRv2 R18 Training/Test Curves",
        help="Figure title",
    )
